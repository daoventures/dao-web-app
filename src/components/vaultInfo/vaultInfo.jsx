...
class Vault extends Component {
  ...
  _getPnl = (asset) => {
    let toFixedPNL = asset && asset.pnl ? asset.pnl.toFixed(2) : `0.00`;
    if (toFixedPNL === "-0.00") {
      toFixedPNL = `0.00`;
    }
    return `${toFixedPNL} %`;
      ...
      <React.Fragment>
        ...
        >
          <div>
            $
            {asset.sumBalances
              ? asset.sumBalances.toFixed(4).toLocaleString()
              : 0}
          </div>
        </Typography>
      </React.Fragment>
  ...
  renderAssetBlocks = () => {
    const { assets, expanded, basedOn, currentTab, disableSetVaultFromURL } =
      this.state;
        ...
        return (
          <div key={index} className={classes.strategyContainer}>
            <Grid container className={classes.itemTop}>
              ...
              {this.state.happyHour && asset.happyHourEnabled && (
                <div className={classes.happyHourLabel}>
                  <span className={classes.happyHourText}>
                    <img
                      className={classes.happyHourSVG}
                      src={Celebrate}
                      alt=""
                    />{" "}
                    Happy Hour
              ...
              >
                <div className={classes.assetSummary}>
                  <Grid container>
                    ...
                    {/** Asset name */}
                    <Grid item sm={3} xs={3} className={classes.gridItemColumn}>
                      <Typography
                        variant={"h5"}
                        className={classes.assetLabel2}
                      >
                    ...
                    <Grid item sm={2} xs={2} className={classes.gridItemColumn}>
                      <div>{this.renderStakedBlocked(asset, false)}</div>
                    </Grid>

                    {/** PNL */}
                    <Grid item sm={2} xs={2} className={classes.gridItemColumn}>
                      <div>{this.renderYearlyGrowth(asset)}</div>
                    </Grid>
                    ...
                    >
                      <div>{this.renderAvailableForDeposit(asset, false)}</div>
                    </Grid>
                  </Grid>
                </div>
              </AccordionSummary>
