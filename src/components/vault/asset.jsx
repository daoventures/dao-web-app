                ...
                <Grid item xs={12}>
                  <div className={ classes.ratioContainer }>
                    <div className={ classes.leftLabelContainer }>
                      <Typography variant='h4' style={{color: '#7B25D2', display: 'flex', alignItems: 'center'}}>
                        <HtmlTooltip 
                          placement={'top'}
                          title={
                            <React.Fragment>
                          ...
                          <InfoIcon style={{verticalAlign: 'text-top', cursor: 'pointer', width: '16px', height: '16px'}} onClick={() => this.handleTooltipEarnClose()} /> 
                        </HtmlTooltip>
                        &nbsp;
                        { 'yEarn: '+ earnRatio + '%' }
                      </Typography>
                    ...
                    <div>
                      <Typography className={ classes.apyText } variant='h4' noWrap>{ 'APY '+ this._getEstimatedAPY(asset) + '%' }</Typography>
                    </div>
                    <div className={ classes.rightLabelContainer }>
                      <Typography variant='h4' style={{color: '#027AFF', display: 'flex', alignItems: 'center'}}>
                        { 'yVault: '+ vaultRatio + '%' }
                        &nbsp;
                        <HtmlTooltip 
                          placement={'top'}
                          ...
                          disableHoverListener
                          disableTouchListener>
                            <InfoIcon style={{verticalAlign: 'text-top', cursor: 'pointer', width: '16px', height: '16px'}} onClick={() => this.handleTooltipVaultClose()} /> 
                        </HtmlTooltip>
                      </Typography>
                    </div>
                  </div>
              ...
              <div className={ classes.tradeContainer }>
                ...
                <div className={ classes.depositIputBox }>
                  ...
                  <div className={ classes.depositScaleContainer }>
                    <Button
                      className={ percent === 25 ? classes.depositScaleActive : classes.depositScale }
                      variant='text'
                      disabled={ loading }
                    ...
                    <Button
                      className={ percent === 50 ? classes.depositScaleActive : classes.depositScale }
                      variant='text'
                      disabled={ loading }
                    ...
                    <Button
                      className={ percent === 75 ? classes.depositScaleActive : classes.depositScale }
                      variant='text'
                      disabled={ loading }
                    ...
                    <Button
                      className={ percent === 100 ? classes.depositScaleActive : classes.depositScale }
                      variant='text'
                      disabled={ loading }
                  ...
                  (asset.strategyType === 'yearn') && 
                    <div className={ classes.yearnEarnAndVaultBlock }>
                      <div className={ classes.yearnEarnAndVaultItem }>
                        <Typography variant='h5' style={{color: '#7B25D2'}} className={ classes.withdrawalText }>Earn</Typography>
                        <Typography variant='h4' 
                          onClick={ () => { this.setRedeemEarnAmount(100) } }  
                          className={ classes.earnAndVaultValue } noWrap>{ (asset.earnBalance ? (Math.floor(asset.earnBalance*asset.earnPricePerFullShare*10000)/10000).toFixed(4) : '0.0000') } { asset.symbol } ({ asset.earnBalance ? (Math.floor(asset.earnBalance*10000)/10000).toFixed(4) : '0.0000' } { asset.vaultSymbol }) </Typography>
                        <TextField
                      ...
                      <div className={ classes.yearnEarnAndVaultItem }>
                        <Typography variant='h5' style={{color: '#027AFF'}} className={ classes.withdrawalText }>Vault</Typography>
                        <Typography variant='h4' 
                          onClick={ () => { this.setRedeemVaultAmount(100) } }  
                          className={ classes.earnAndVaultValue } noWrap>{ (asset.vaultBalance ? (Math.floor(asset.vaultBalance*asset.vaultPricePerFullShare*10000)/10000).toFixed(4) : '0.0000') } { asset.symbol } ({ asset.vaultBalance ? (Math.floor(asset.vaultBalance*10000)/10000).toFixed(4) : '0.0000' } { asset.vaultSymbol }) </Typography>
                        <TextField
                          fullWidth
                          className={ `${classes.actionInput} ${classes.earnAndVaultInput}` }
