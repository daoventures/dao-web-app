          ...
          <img
            ...
            src={
              this.state.currentTheme === "light"
                ? require("../../../assets/img_new/comingsoon_light@2x.png")
                : require("../../../assets/img_new/comingsoon_dark@2x.png")
            }
          />
          <p>Coming Soon</p>
        </div>
...
export default withNamespaces()(withRouter(withStyles(styles)(ComingSoon)));
