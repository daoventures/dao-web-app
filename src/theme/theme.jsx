...
const colorObj = {
  dark: {
    ...
    modelBack: "linear-gradient(223deg, rgba(36, 33, 81, 0.54) 0%, rgba(38, 35, 83, 0.8) 40%, rgba(28, 26, 67, 0.45) 100%)",
    textT: "#ffffff",
    textP: "#7367F7",
    textS: "#7B25D2",
    textH: "#027AFF",
    ...
    menuSel: 'linear-gradient(90deg, #15023A 0%, rgba(12, 2, 32, 0.03) 100%, rgba(11, 2, 30, 0) 100%)',
