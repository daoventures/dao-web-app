  ...
  _getDefaultValues = (network) => {
    const vaultAssetsObj = {
      1: [
        ...
        //   erc20address:'0xdac17f958d2ee523a2206206994597c13d831ec7',
        //   vaultContractAddress: "0x4F0C1c9bA6B9CCd0BEd6166e86b672ac8EE621F7",
        //   // vaultContractABI: '', // can get from here: https://kovan.etherscan.io/address/0x542a42496C96b946324f7dce2B030d5643d9eF8A#code
        //   balance: 0,
        //   vaultBalance: 0,
        //   decimals: 18,
        //   deposit: true,
        ...
        //   // START FROM HERE
        //   strategyName: 'DAO Citadel',
        //   strategy: 'DAO Citadel',
        //   strategyAddress: '0x4996b12560b9a4a85dd437a3e8ff489335dcffa7',
        //   // strategyContractABI: '', // can get from here: https://kovan.etherscan.io/address/0x4996b12560B9A4A85DD437A3e8ff489335dCffA7#code
      ...
      //     erc20address:'0x07de306ff27a2b630b1141956844eb1552b956b5',
      //     vaultContractAddress: "0x6B150E9BD70E216775c8b73270E64e870a3110c1",
      //     vaultContractABI: config.vaultDAOCDVContractABI, // can get from here: https://kovan.etherscan.io/address/0x542a42496C96b946324f7dce2B030d5643d9eF8A#code
      //     balance: 0,
      //     vaultBalance: 0,
      //     decimals: 18,
      //     deposit: true,
      ...
      //     strategy: 'DAO Citadel',
      //     strategyAddress: '0x4996b12560b9a4a85dd437a3e8ff489335dcffa7',
      //     strategyContractABI: config.strategyDAOCDVContractABI, // can get from here: https://kovan.etherscan.io/address/0x4996b12560B9A4A85DD437A3e8ff489335dCffA7#code
      //     historicalPriceId: 'daoCDV_price',
      //     logoFormat: 'png',
      //     risk: 'Expert',
      //     strategyType: 'citadel',
      ...
      //     USDTvaultContractABI: config.vaultUSDTContractABI,
      //     USDTstrategyContractABI: config.strategyUSDTContractABI,
      //     USDCvaultContractABI: config.vaultUSDCContractABI,
      //     USDCstrategyContractABI: config.strategyUSDCContractABI,
      //     DAIvaultContractABI: config.vaultDAIContractABI,
      //     DAIstrategyContractABI: config.strategyDAIContractABI,
  ...
  getStrategyBalancesFull = async (payload) => {
    ...
    async.map(assets, (asset, callback) => {
      async.parallel([
        ...
        (callbackInner) => { this._getHistoricalAPY(web3, asset, account, interval, callbackInner) },
        (callbackInner) => { this._getTvl(asset.tvlKey, callbackInner) },
